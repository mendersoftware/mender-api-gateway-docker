[![Build Status](https://travis-ci.org/mendersoftware/mender-api-gateway-docker.svg?branch=1.1.x)](https://travis-ci.org/mendersoftware/mender-api-gateway-docker)
